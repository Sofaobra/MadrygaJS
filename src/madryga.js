...
(function() {
    ...
    /**
     * Генерирует все ключи каждого раунда, необходимые для шифрования/дешифрования текста произвольной длинны
     * @param {Long} key Ключ для шифрования/дешифрования
     * @param {int} rounds Количество раундов для генерации подключей
     * @return {Array<Long>} Массив подключей (ключи раундов)
     */
